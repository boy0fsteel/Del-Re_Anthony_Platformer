...
//PUT IN YOUR DEATH STUFF IDIOTQ
  // Losing animation
...
//what the enemy does to the player
    } else if (type =="enemy") {
    this.status = "lost";
    this.finishDelay = 1;

//What the boss does to the player
   } else if (type =="boss") {
    this.status = "lost";
    this.finishDelay = 1;
  
//What the coin does to the player
  } else if (type == "coin") {
